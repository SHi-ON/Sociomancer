...
def run(playwright: Playwright) -> None:
    ...
    while True:
        ...
        page.get_by_role("button", name=f"Page {page_number}").click()
        print('Go to page', page_number)
        time.sleep(4)
        ...
        for i, profile_url in enumerate(profile_links):
            ...
            if element:
                ...
                if (LOCATION_CONSTRAINT_1 in text_content or
                    ...
                    logging.warning(
                        f'Location text is different: {text_content}')
                    continue
            else:
            ...
            try:
                ...
                print(
                    f"Could not remove connection for {profile_url}: {str(e)}")
